    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_role', models.CharField(choices=[('S', 'Student'), ('A', 'Alumni'), ('C', 'Company')], max_length=1, verbose_name='Role')),
                ('user_contact', models.IntegerField(verbose_name='Contact')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('graduating_year', models.IntegerField(validators=[django.core.validators.MinValueValidator(1950), django.core.validators.MaxValueValidator(2100)], verbose_name='Graduating Year')),
